...
class AccessToken
{
   ...
   //static function init($appID, $appCertificate, $uid,$privilegeExpiredTs)
   static function init($appID, $appCertificate, $channelName,$uid, $role, $privilegeExpiredTs)
    {
        // print_r($appID.'-'. $appCertificate.'-'. $channelName.'-'. $uid.'-'. $role.'-'. $privilegeExpiredTs);
        ...
        // $accessToken->addPrivilege( $appID,$privilegeExpiredTs);
        $accessToken->message = new Message("hello");
